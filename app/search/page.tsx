												...
												<div className='mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between'>
													<div className='flex flex-col space-y-2'>
														<div className='flex items-center space-x-2'>
															...
															{profile.skills && profile.skills.length ? (
																<div className='flex flex-wrap gap-1'>
																	...
																	{profile.skills && profile.skills.length > 3 && (
																		<Badge variant='outline'>+{profile.skills.length - 2}</Badge>
																	)}
																</div>
															) : (
														...
														<div className='flex items-center space-x-2'>
															...
															{profile.looking_for && profile.looking_for.length ? (
																<div className='flex flex-wrap gap-1'>
																	...
																	{profile.looking_for && profile.looking_for.length > 3 && (
																		<Badge variant='outline'>+{profile.looking_for.length - 2}</Badge>
																	)}
																</div>
															) : (
														...
														<div className='flex items-center space-x-2'>
															...
															{profile.conditions && profile.conditions.length ? (
																<div className='flex flex-wrap gap-1'>
																	{profile.conditions?.slice(0, 3)?.map((looking, i) => (
																		<Badge key={i} variant='outline'>
																			{looking}
																		</Badge>
																	))}
																	{profile.conditions && profile.conditions.length > 3 && (
																		<Badge variant='outline'>+{profile.conditions.length - 3}</Badge>
																	)}
																</div>
															) : (
																<small className='text-muted-foreground'>
