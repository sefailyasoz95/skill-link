...
export default function AdminPage() {
	...
	const generateMockStats = (users: User[]) => {
		// Mock weekly signups
				...
				<div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
					...
					<Card>
						...
						<CardContent>
							...
							<p className='text-xs text-muted-foreground'>{Math.floor(Math.random() * 15) + 5}% from last week</p>
						</CardContent>
					</Card>
				</div>
				...
				<Tabs defaultValue='users'>
					<TabsList>
						...
						<TabsTrigger value='moderation'>
							Moderation
							<span className='ml-2 rounded-full bg-red-500 px-1.5 py-0.5 text-xs text-white'>2</span>
						</TabsTrigger>
										...
										{loading ? (
											...
											filteredUsers.map((user) => (
												<TableRow key={user.id}>
													...
													<TableCell>{user.username || "No email"}</TableCell>
						...
						<div className='grid gap-4 md:grid-cols-2 lg:grid-cols-7'>
							...
							<Card className='col-span-3'>
								<CardHeader>
									...
									<CardDescription>Most common skills on the platform</CardDescription>
								</CardHeader>
								<CardContent>
					...
					<TabsContent value='moderation' className='space-y-4'>
						<Card>
							<CardHeader>
								...
								<CardDescription>Review and moderate reported user content</CardDescription>
							</CardHeader>
							<CardContent>
								<Table>
									<TableHeader>
					...
					<TabsContent value='settings' className='space-y-4'>
						<Card>
							<CardHeader>
								...
								<CardDescription>Configure global platform settings and permissions</CardDescription>
							</CardHeader>
							<CardContent className='space-y-4'>
								...
								<div className='space-y-1'>
									...
									<div className='flex items-center justify-between rounded-lg border p-4'>
										<div className='space-y-0.5'>
											<p>System emails</p>
											<p className='text-sm text-muted-foreground'>Configure email templates and sending schedule</p>
										</div>
										<div>
											<Button variant='outline'>Configure</Button>
										</div>
