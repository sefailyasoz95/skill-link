          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-16 items-center drop-shadow-xl">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                >
                  Connect with like-minded solopreneurs to collaborate on
                  projects, share skills, and grow your business together.
                </p>
              </div>
              {/* <div
              ...
              >
                ...
                <span>
                  ...
                  and connect with other solopreneurs
                  {/* already connected */}
                </span>
              </div>
            </div>
        ...
        <div className="container px-4 md:px-6 relative z-10">
          ...
          <div className="grid gap-8 md:grid-cols-3 relative">
            ...
            <div className="flex flex-col items-center text-center space-y-6 group">
              ...
              <p
                className="text-gray-500 dark:text-gray-400 animate-fadeIn"
                style={{ animationDelay: "0.2s" }}
              >
                Showcase your skills, past projects, and what you're looking for
                in a collaborator.
              </p>
              <div className="pt-2">
                <Link
            ...
            <div className="flex flex-col items-center text-center space-y-6 group">
              ...
              <p
                ...
                style={{ animationDelay: "0.3s" }}
              >
                Search and filter through our network of solopreneurs to find
                your perfect match.
              </p>
              <div className="pt-2">
                <Link
            ...
            <div className="flex flex-col items-center text-center space-y-6 group">
              ...
              <p
                ...
                style={{ animationDelay: "0.4s" }}
              >
                Connect directly, discuss terms, and begin building your project
                together.
              </p>
              <div className="pt-2">
                <Link
