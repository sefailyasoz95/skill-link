									...
									<div className='flex items-center space-x-4'>
										...
										<div>
											...
											<p className='text-sm text-muted-foreground'>
												{profile.full_name ? "Your profile is visible to others" : "Your profile is incomplete"}
											</p>
										</div>
									</div>
											...
											<CardContent className='p-4'>
												<div className='flex items-start space-x-4'>
													...
													<div className='flex-1 space-y-1'>
														<p className='font-medium'>{connection.profile?.full_name || "Unnamed User"}</p>
														<div className='flex flex-wrap gap-1'>
															...
															{connection.profile?.skills && connection.profile.skills.length > 3 && (
												...
												<div className='mt-4 flex items-center justify-end space-x-2'>
													<Button asChild variant='outline' size='sm'>
														<Link href={`/profile/${connection.profile?.id}`}>View Profile</Link>
													</Button>
										...
										<Card key={connection.id}>
											<CardContent className='p-4'>
												...
												<div className='mt-4 flex items-center justify-end space-x-2'>
													...
													<Button size='sm' onClick={() => handleConnectionResponse(connection.id, true)}>
														Accept
													</Button>
												</div>
											</CardContent>
