      ...
      try {
        ...
        if (chatMembers && chatMembers.length > 0) {
          ...
          for (const member of chatMembers) {
            ...
            const { data: recipientMember, error: recipientError } =
              await supabase
                .from("chat_members")
                .select("chat_id")
                .eq("chat_id", chat.id)
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="rounded-lg border p-4 bg-muted/20">
                ...
                <p className="text-sm text-muted-foreground">
                  This will start a new conversation. You can send messages to
                  this user after you connect.
                </p>
              </div>
