      ...
      <div className="mx-auto max-w-5xl space-y-8">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Chat with your connections and collaborate on projects
          </p>
        </div>
              ...
              <div className="space-y-3">
                {filteredConversations.map((conversation) => (
                  <Link
                    ...
                    className="block"
                  >
                    <div className={`flex items-start space-x-4 rounded-lg border p-4 transition-colors hover:bg-muted/50 ${conversation.unreadCount > 0 ? 'bg-primary/5' : ''}`}>
                      <div className="relative">
                      ...
                      <div className="flex-1 space-y-1">
                        <div className="flex items-center justify-between">
                          <p className={`font-medium ${conversation.unreadCount > 0 ? 'text-foreground' : 'text-muted-foreground'}`}>
                        ...
                        <p className={`text-sm line-clamp-1 ${conversation.unreadCount > 0 ? 'font-medium text-foreground' : 'text-muted-foreground'}`}>
